...
// generated constants (defined in dc_constants.c)
extern const int i_DC_GCL_ARCHIVED_ONLY;
extern const int i_DC_GCL_NO_SPECIALS;
extern const int i_DC_GCL_ADD_ALLDONE_HINT;
extern const int i_DC_GCL_VERIFIED_ONLY;
extern const int i_DC_GCL_ADD_SELF;
extern const int i_DC_CHAT_ID_DEADDROP;
extern const int i_DC_CHAT_ID_TRASH;
extern const int i_DC_CHAT_ID_MSGS_IN_CREATION;
extern const int i_DC_CHAT_ID_STARRED;
extern const int i_DC_CHAT_ID_ARCHIVED_LINK;
extern const int i_DC_CHAT_ID_ALLDONE_HINT;
extern const int i_DC_CHAT_ID_LAST_SPECIAL;
extern const int i_DC_CHAT_TYPE_UNDEFINED;
extern const int i_DC_CHAT_TYPE_SINGLE;
extern const int i_DC_CHAT_TYPE_GROUP;
extern const int i_DC_CHAT_TYPE_VERIFIED_GROUP;
extern const int i_DC_STATE_UNDEFINED;
extern const int i_DC_STATE_IN_FRESH;
extern const int i_DC_STATE_IN_NOTICED;
extern const int i_DC_STATE_IN_SEEN;
extern const int i_DC_STATE_OUT_PENDING;
extern const int i_DC_STATE_OUT_FAILED;
extern const int i_DC_STATE_OUT_DELIVERED;
extern const int i_DC_STATE_OUT_MDN_RCVD;
extern const int i_DC_CONTACT_ID_SELF;
extern const int i_DC_CONTACT_ID_DEVICE;
extern const int i_DC_CONTACT_ID_LAST_SPECIAL;
extern const int i_DC_EVENT_INFO;
extern const int i_DC_EVENT_SMTP_CONNECTED;
extern const int i_DC_EVENT_IMAP_CONNECTED;
extern const int i_DC_EVENT_SMTP_MESSAGE_SENT;
extern const int i_DC_EVENT_WARNING;
extern const int i_DC_EVENT_ERROR;
extern const int i_DC_EVENT_MSGS_CHANGED;
extern const int i_DC_EVENT_INCOMING_MSG;
extern const int i_DC_EVENT_MSG_DELIVERED;
extern const int i_DC_EVENT_MSG_FAILED;
extern const int i_DC_EVENT_MSG_READ;
extern const int i_DC_EVENT_CHAT_MODIFIED;
extern const int i_DC_EVENT_CONTACTS_CHANGED;
extern const int i_DC_EVENT_CONFIGURE_PROGRESS;
extern const int i_DC_EVENT_IMEX_PROGRESS;
extern const int i_DC_EVENT_IMEX_FILE_WRITTEN;
extern const int i_DC_EVENT_FILE_COPIED;
extern const int i_DC_EVENT_SECUREJOIN_INVITER_PROGRESS;
extern const int i_DC_EVENT_SECUREJOIN_JOINER_PROGRESS;
extern const int i_DC_EVENT_IS_OFFLINE;
extern const int i_DC_EVENT_GET_STRING;
extern const int i_DC_EVENT_GET_QUANTITY_STRING;
extern const int i_DC_EVENT_HTTP_GET;