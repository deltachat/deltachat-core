...
int mrsqlite3_open__(mrsqlite3_t* ths, const char* dbfile, int flags)
{
	...
	if( !(flags&MR_OPEN_READONLY) )
	{
		...
		if( !mrsqlite3_table_exists__(ths, "config") )
		{
			...
			mrsqlite3_execute__(ths, "INSERT INTO chats (id,type,name) VALUES (1,120,'deaddrop'), (2,120,'to_deaddrop'), (3,120,'trash'), (4,120,'msgs_in_creation'), (5,120,'archivedlink'), (6,120,'starred'), (7,100,'rsvd'), (8,100,'rsvd'), (9,100,'rsvd');");
			#if !defined(MR_CHAT_NORMAL) || MR_CHAT_NORMAL!=100 || MR_CHAT_GROUP!=120 || MR_CHAT_ID_DEADDROP!=1 || MR_CHAT_ID_TO_DEADDROP!=2 || MR_CHAT_ID_TRASH!=3 || MR_CHAT_ID_MSGS_IN_CREATION!=4 || MR_CHAT_ID_ARCHIVED_LINK!=5 || MR_CHAT_ID_STARRED!=6
				#error
			#endif
