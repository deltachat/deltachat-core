...
char*           dc_get_message_kml        (dc_context_t*, double latitude, double longitude, double accuracy);
...
uint32_t        dc_save_locations         (dc_context_t*, uint32_t chat_id, uint32_t contact_id, const dc_array_t*);
