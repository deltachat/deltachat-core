...
static const char* s_ent[] = {
	"lt;",   "<",  /* it's also possible to specify the destination as a character reference as `&#34;` */
	"gt;",   ">",
	"quot;", "\"",
	"apos;", "'",
	"amp;",  "&",
	/* advanced encodings - TODO: here's still something missing, see eg. PHP's htmlentities() */
	"nbsp;", " ",
	NULL,    NULL
};
