 ...
 * @file
 *
 * The following constants are used as events reported to the callback given to dc_context_new().
 *
 ...
 *
 * @param data1 Error code, see dc_error.h for a list of constants.
 *
 ...
 *
 * See also #DC_EVENT_SECUREJOIN_JOINER_PROGRESS
 *
 ...
 *
 * See also #DC_EVENT_SECUREJOIN_INVITER_PROGRESS
 *
 * @param data1 ID of the contact that wants to join.
 *
 * @param data2 Progress as:
